...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './empty-trash-images.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPTYTRASHIMAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPTYTRASHIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPTYTRASHIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPTYTRASHIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPTYTRASHIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPTYTRASHIMAGES actions', async () => {
      const expectedActions = [
        {
