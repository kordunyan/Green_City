...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './osbb.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OSBB_LIST actions', async () => {
    ...
    it('dispatches FETCH_OSBB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OSBB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OSBB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OSBB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OSBB actions', async () => {
      const expectedActions = [
        {
