...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './trash-exportation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRASHEXPORTATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRASHEXPORTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRASHEXPORTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRASHEXPORTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRASHEXPORTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRASHEXPORTATION actions', async () => {
      const expectedActions = [
        {
