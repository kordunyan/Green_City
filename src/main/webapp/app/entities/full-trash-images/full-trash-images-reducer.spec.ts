...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './full-trash-images.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FULLTRASHIMAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_FULLTRASHIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FULLTRASHIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FULLTRASHIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FULLTRASHIMAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FULLTRASHIMAGES actions', async () => {
      const expectedActions = [
        {
