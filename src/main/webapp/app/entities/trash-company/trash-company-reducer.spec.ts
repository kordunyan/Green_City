...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRASHCOMPANY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRASHCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRASHCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRASHCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRASHCOMPANY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRASHCOMPANY actions', async () => {
      const expectedActions = [
        {
